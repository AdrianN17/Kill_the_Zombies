...
function game:to_pausa()
	if be.pausar and be.player.estado.vida then
		Gamestate.push(pausa)
		be.pausar=false
	end
end

function game:to_menu()
	if be.menu and not be.player.estado.vida then
		self:save_score()
		be:clear()
		be.menu=false
...
function game:again()
	if be.reiniciar  and not be.player.estado.vida then
		self:save_score()
		be:clear()
		self:enter()
		be.reiniciar=false
